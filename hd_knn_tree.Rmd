...
Before proceeding straight into the algorithm, I imported the project's dataframe. Like the previous logistic regression project, the erronous attribute was corrected. However this time, the `knn` function required the response variable as the factor(categorical variable).
...
```
Also, the normalization of all dependent variable was conducted prior to the analysis.
