...
df2 <- read.csv("Heart.csv", header = TRUE)
colnames(df2)[colnames(df2)=='ï..age'] <- 'age'
...
sample_dt = sample.split(df2, SplitRatio = 0.75)
train_dt_df = subset(df2, sample_dt==TRUE)
test_dt_df = subset(df2,sample_dt==FALSE)
```
