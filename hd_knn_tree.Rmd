...
The overall accuracy of the model is 0.7674 with the 95% confidence interval of 0.6639 and 0.8518. The algorithm correctly predicted 66 patients out of 86 patients. out of 39 patients who did not carry the heart disease, 11 patients were falsely diagnosed (Type I error): carrying heart disease. Similary, `test_dt_df` categorized 47 heart disease patients, 9 patients were predicted not suffering heart disease (Type II error). 
...
The ROC curve is above the grey line. It indicates that the prediction at any given point is correctly classifying the result. The quantifying measure of the curve is 0.7608 which can be considered as moderately accurate model.
...
```{r Logistic Regression, echo=FALSE, fig.height=5, fig.width=6}
